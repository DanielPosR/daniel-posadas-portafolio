...
export default function MenuResponsive() {
    ...
    function scrollNav() {
        ...
        enlaces.forEach(enlace => {
            enlace.addEventListener('click', function (e) {
                ...
                const scrollTo = seccion.offsetTop - 80;
    ...
    return (
        <div className={`menuBtn ${isActive ? `active` : ''}`} onClick={toggleMenu}>
            ...
            <nav className={`nav ${isActive ? `active` : ''}`}>
                <ul>
                    ...
                    <li>
                        ...
                        <label htmlFor="" id="theme-toggle-button">
                        ...
                        {/* <img src={modoOscuro ? '/img/lightmode.svg' : '/img/darkmode.svg'} alt="Icono selector tema" onClick={() => {
                            setModoOscuro(!modoOscuro)
                            cambiarTema();
                        }}
                            width={45}
