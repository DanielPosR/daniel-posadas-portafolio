    ...
    return (
        <>
            <div className="social-buttons">
                <a href="https://github.com/DanielPosR" target='_blank' rel="noreferrer" className="social-button github">
                ...
                <a href="https://www.linkedin.com/in/daniel-posadas-rangel/" target='_blank' rel="noreferrer" className="social-button linkedin">
                ...
                <a href="https://drive.google.com/file/d/1FtdFKEKFNTghjqud6vPP44WWvOe5-4VB/view?pli=1" target='_blank' rel="noreferrer" className="social-button instagram">
