    ...
    return (
        <>
            <div className="social-buttons">
                <a href="https://github.com/DanielPosR" target='_blank' rel="noreferrer" className="social-button github" aria-label='Enlace hacia mi perfíl de Github'>
                ...
                <a href="https://www.linkedin.com/in/daniel-posadas-rangel/" target='_blank' rel="noreferrer" className="social-button linkedin" aria-label='Enlace hacia mi perfól de Linkedin'>
                ...
                <a href="https://drive.google.com/file/d/1FtdFKEKFNTghjqud6vPP44WWvOe5-4VB/view?pli=1" target='_blank' rel="noreferrer" className="social-button instagram" aria-label='Enlace hacia mi Curriculum - CV'>
